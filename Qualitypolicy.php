...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-12 p-0">
            <img src="hos6.jpg" width="100%" height="500px">
</div>
</div>
<br>
<br>
...
<div class="row">
    <div class="col-sm-6 ">
        <img src="hos54.jpg" width="100%" height="400px">
</div>
<div class="col-sm-6">
    ...
    <br>
    <p>
        Sahara Hospital is committed to deliver high quality patient care through application of latest technology coupled with medical excellence safety of treatment during patients stay.promoting an environment of continuous quality improvement and complying with statutory regulations.
    </p>
